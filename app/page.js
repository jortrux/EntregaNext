...
//     const res = await fetch("http://localhost:3000/api/comercios/buscar")
//     const data = await res.json()
//     console.log("data", data.comercios)
//     return data.comercios
// }

// export default async function buscarComercios() {
...
//                                 <h5 className="font-bold">CIF: {comercio.cif}</h5>
//                         </ul>
//                         <ul key={uuidv4()} className="card-text">
//                                 <h5 className="font-bold">Ciudad: {comercio.ciudad}</h5>
//                         </ul>
//                         <ul key={uuidv4()} className="card-text">                            
//                             <h5 className="font-bold">Email: {comercio.email}</h5>
//                         </ul>
//                         <ul key={uuidv4()} className="card-text">                            
//                             <h5 className="font-bold">Telefono: {comercio.telefono}</h5>
//                         </ul>
//                     </div>
//                 </div>
//             ))}
